...
const Formulario = ({ pacientes, paciente, setPacientes, setPaciente }) => {
    ...
    //genera un ID de manera aleatoria
    const generarID = () => {
    ...
    return (
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            <form className="bg-white shadow-md rounded-lg py-10 px-5 ml-5 mb-5" onSubmit={handlerSubmit}>
                <div className="mb-5">
                ...
                <div className="mb-5">
                    ...
                    <input id="propietario" type="text" placeholder="Nombre del propetario" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" value={propietario} onChange={(e) => setPropietario(e.target.value)} />
                </div>

                <div className="mb-5">
                    <label htmlFor="email" className=" text-gray-700 uppercase font-bold" >Email</label>
                    <input id="email" type="email" placeholder="Email de contacto de propietario" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
                ...
                <div className="mb-5">
                    ...
                    <textarea id="sintomas" placeholder="Describe los sintomas de tu mascota" className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" value={sintomas} onChange={(e) => setSintomas(e.target.value)} />
                </div>
